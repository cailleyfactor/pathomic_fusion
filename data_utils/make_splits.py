...
# opt = parse_opt_file('checkpoints/TCGA_GBMLGG/grad_15/pathgraphomic_fusion/train_opt.txt')
opt = parse_args()
...
# Creates a dictionary mapping patient IDs to their corresponding filenames
