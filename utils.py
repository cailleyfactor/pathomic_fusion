...
# Applies the regularisation to all the weights in the model
...
# Applies L1 regularisation to the weights of the classifier and linar modules of the model
