## This code is for training the models on the TCGA KIRC dataset. It is a modified version of the train_cv.py file.
import os
import logging
import numpy as np
import pickle
...
from training_utils.train_test_kirc import train, test
