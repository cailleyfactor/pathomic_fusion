...
def test(opt, model, data, split, device):
    ...
    # Risk_pred_all is hazards, survtime_all is survival times, censor_all is censoring indicators, probs_all is the predicted probabilities, gt_all is the ground truth
