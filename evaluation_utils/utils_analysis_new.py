...
# Modified code from an original function from the repo to get the test patients
...
# Aggregates the hazards and other data based on patient name
...
# Aggregates the grade data based on patient name
...
# Aggregates the hazards and other data based on patient name for TCGA-KIRC
